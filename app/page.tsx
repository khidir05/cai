...
export default function Home() {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[#63c5eb]/10 backdrop-blur-2xs pointer-events-none" />
      ...
      <div className="w-full max-w-md bg-white/95 backdrop-blur-md rounded-3xl border border-slate-100 p-8 flex flex-col items-center shadow-2xl relative z-10 text-center">
        ...
        <div className="flex flex-col items-center mb-6">
          ...
          <p className="text-[10px] text-[#63c5eb] font-extrabold tracking-widest uppercase mt-1">
            CAI 47 Cinta Alam Indonesia
          </p>
        </div>

        <div className="w-12 h-1 bg-[#63c5eb] rounded-full mb-6" />
        ...
        <Link 
          href="/saran"
          className="w-full py-4 bg-[#63c5eb] hover:bg-[#4baecd] text-white font-bold text-xs rounded-2xl transition-all shadow-md flex items-center justify-center gap-2 active:scale-[0.99] group"
        >
